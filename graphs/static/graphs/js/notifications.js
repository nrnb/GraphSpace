	...
	function constructURLFromEventType(event_type, graph_id, user_id, group_id, group_owner, layout_name, layout_owner) {
		...
		switch(parseInt(event_type)) {
			...
			case 2:
				...
				return href;
			case 3:
				href += "graphs/" + user_id + "/" + graph_id + "?layout_owner=" + layout_owner + "&layout_name=" + layout_name;
				return href;
			case 4:
			...
			case 8:		
			case 9:
				href += "tasks/" + user_id + "/" + graph_id + "?layout_owner=" + layout_owner + "&layout_name=" + layout_name;
				return href;
			case 10:
				href += "tasks/" + user_id + "/" + graph_id + "/";
				return href;
